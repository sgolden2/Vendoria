...
class Place(models.Model):
	...
	def __str__(self):
		return self.name + ' | ' + self.type + ' in ' + self.region
...
class Purchase(models.Model):
	...
	def __str__(self):
		return self.customer + ' | ' + self.amount + ' | ' + self.DOT
...
class Inventory(models.Model):
	...
	def __str__(self):
		return self.place + ' | ' + self.product + ' | ' + self.quantity + '/' + self.max_amount + ' -> ' + self.status
